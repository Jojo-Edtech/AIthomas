(function () {
  ...
  const dict = {
    zh: {
      ...
      headerTitleCompact: "AI Thomas",
      statusHeading: "服务状态",
      checkingModel: "正在检查模型连接",
      loadingCorpus: "正在读取本地论文语料",
      statusCorpus: "{p} 篇论文 · {c} 个证据片段",
      freeQuota: " · 额度保护",
      apiConnected: "{label} 已连接{quota}",
      apiNotConnected: "{label} 未连接",
      noService: "服务未响应",
      statusFailed: "状态检查失败",
      workspaceHeading: "工作空间",
      resetGuest: "重置",
      signOut: "退出登录",
      ...
      composerPlaceholder: "直接输入研究问题、idea、段落或追问",
      send: "发送",
      panelHide: "收起",
      panelTools: "展开",
      matchingMethod: "正在匹配方法",
      copy: "复制",
      copied: "已复制",
      copyFailed: "复制失败",
      evidenceUsed: "证据与方法来源",
      roleYou: "你",
      roleSystem: "系统",
      activeTool: "当前工具：",
      ...
      greeting:
        "你好，我是 AI Thomas。把研究想法、论文段落或追问直接发给我，我会根据每轮问题选择合适的研究分析与写作方法，并标明证据边界。",
      loadingMsg: "正在匹配研究方法与本地论文证据...",
      wfMatrixPrompt:
        "请作为科研导师助手，把下面的研究方向拆成“对象 × 产出类型”的研究矩阵。\n\n研究方向：\n\n输出请包括：一句话结论、研究矩阵表、3 个可写 paper 方向、下一步行动、证据边界。",
      wfBoundaryPrompt:
        "请作为科研导师助手，帮我区分下面概念的边界，并说明如何定义、测量和写进论文。\n\n概念：\n\n输出请包括：定义对照表、边界判断、测量建议、分析依据、证据边界。",
      wfVariablePrompt:
    ...
    en: {
      ...
      statusCorpus: "{p} papers · {c} evidence passages",
      freeQuota: " · quota protected",
      apiConnected: "{label} connected{quota}",
      apiNotConnected: "{label} not connected",
      ...
      composerPlaceholder: "Ask a research question, share an idea, paragraph, or follow-up",
      send: "Send",
      panelHide: "Hide",
      panelTools: "Expand",
      ...
      evidenceUsed: "Evidence and method sources",
      roleYou: "You",
      roleSystem: "System",
      ...
      greeting:
        "Hi, I'm AI Thomas. Send a research idea, paper paragraph, or follow-up directly; I will match an appropriate research or writing method for each turn and state the evidence boundary.",
      loadingMsg: "Matching a research method and local paper evidence...",
      wfMatrixPrompt:
